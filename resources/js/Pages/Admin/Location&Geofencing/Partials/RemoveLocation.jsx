...
export default function RemoveLocation({ locationId, refreshLocations }) {
    ...
    const remove = (e) => {
        ...
        post(route('admin.location.remove'), {
            onSuccess: () => {
                reset('id');
